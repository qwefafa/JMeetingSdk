...
import cn.redcdn.hnyd.profiles.adapter.CollectionListAdapter;
import cn.redcdn.hnyd.util.CommonUtil;
import cn.redcdn.hnyd.util.CustomToast;
import cn.redcdn.hnyd.util.TitleBar;
import cn.redcdn.log.CustomLog;

import static cn.redcdn.hnyd.profiles.adapter.CollectionListAdapter.CHAT_TYPE;
...
public class CollectionActivity extends BaseActivity implements CollectionListAdapter.CollectionDataListCallBack {
    ...
    private void initDataFirst() {
        ...
        AuthenticateInfo userInfo = AccountManager.getInstance(MedicalApplication.getContext()).getmAuthInfo();
        mGetCollectItems.getCollectionItem(userInfo.getNubeNumber(), userInfo.getAccessToken(), 0);
