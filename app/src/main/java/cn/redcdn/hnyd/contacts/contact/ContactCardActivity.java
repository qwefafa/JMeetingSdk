...
import cn.redcdn.hnyd.contacts.VerificationActivity;
import cn.redcdn.hnyd.contacts.VerificationReplyDialog;
import cn.redcdn.hnyd.contacts.contact.ContactDeleteDialog.NoClickListener;
import cn.redcdn.hnyd.contacts.contact.ContactDeleteDialog.OkClickListener;
import cn.redcdn.hnyd.contacts.contact.diaplayImageListener.DisplayImageListener;
...
import cn.redcdn.hnyd.contacts.manager.AddFriendCallback;
import cn.redcdn.hnyd.contacts.manager.DeleteFriendCallback;
import cn.redcdn.hnyd.contacts.manager.FriendSync;
...
import cn.redcdn.hnyd.im.view.CustomDialog1;
...
import static cn.redcdn.hnyd.R.id.iamgehead;
    ...
    public void onActivityResult(int requestCode,int resultCode,Intent data) {
        ...
        if(resultCode == ContactTransmitConfig.RESULT_REPLY_CODE){
            ...
            MedicalApplication.getFileTaskManager().sendStrangerMsg(AccountManager.getInstance(this).getNube(),
                    ...
                    AccountManager.getInstance(this).getmAuthInfo().getHeadUrl(),reply,true);
        ...
        if(resultCode == ContactTransmitConfig.RESULT_VERIFICATION_CODE){
            ...
            MedicalApplication.getFileTaskManager().sendStrangerMsg(AccountManager.getInstance(this).getNube(),
                    mContact.getNubeNumber(),AccountManager.getInstance(this).getName(),
                    AccountManager.getInstance(this).getmAuthInfo().getHeadUrl(),message,false);
