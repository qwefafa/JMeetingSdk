...
import cn.redcdn.hnyd.contacts.NewFriendsListViewAdapter.buttonClick;
...
import static cn.redcdn.hnyd.im.activity.ChatActivity.VALUE_CONVERSATION_TYPE_SINGLE;
...
//                    enterChatActivity(newfriendInfoList.get(position).getNubeNumber());
    ...
    private void getAllFriends(){
        FriendsManager.getInstance().getAllFriends(
                new FriendCallback(){
                    @Override
                    public void onFinished(cn.redcdn.hnyd.im.interfaces.ResponseEntry result){
