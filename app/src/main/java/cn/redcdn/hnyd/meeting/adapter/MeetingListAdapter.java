package cn.redcdn.hnyd.meeting.adapter;
...
import cn.redcdn.hnyd.meeting.Holder.MeetingListViewHolder;
...
public class MeetingListAdapter extends RecyclerView.Adapter<MeetingListViewHolder> implements View.OnClickListener {
    ...
    public void onBindViewHolder(MeetingListViewHolder holder, int position) {
        ...
        //判断创建者是不是自己
        if (!AccountManager.getInstance(mContext).getmAuthInfo().getNubeNumber().equals(mDatas.get(position).creatorId)) {
