package cn.redcdn.hnyd.im.util;
...
import cn.redcdn.hnyd.im.activity.MultiBucketChooserActivity;
import cn.redcdn.hnyd.im.activity.RecordFinishVideoActivity;
import cn.redcdn.hnyd.im.activity.RecordingVideoAndPictureActivity;
...
import cn.redcdn.hnyd.profiles.dialog.CameraImageDialog;
...
//        menuDlg.show();
    ...
    private static void showLoadingView(String message,
        ...
        dialog = cn.redcdn.hnyd.util.CommonUtil.createLoadingDialog(mActivity, message, listener);
