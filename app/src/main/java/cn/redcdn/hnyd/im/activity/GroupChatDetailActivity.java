...
import cn.redcdn.hnyd.im.adapter.GroupChatMembersIconAdapter;
import cn.redcdn.hnyd.im.bean.ContactFriendBean;
import cn.redcdn.hnyd.im.bean.GroupBean;
...
import cn.redcdn.hnyd.im.view.CustomGridView;
import cn.redcdn.hnyd.im.view.MedicalAlertDialog;
import cn.redcdn.hnyd.im.view.SwitchButton;
...
public class GroupChatDetailActivity extends BaseActivity implements OnClickListener
    ...
    private void initData() {
        ...
        if (mChatType.equals(VALUE_GROUP)) {
            ...
            if (mGetGroupCslFail.equals(VALUE_GETGROUPCSLSUCCESS)) {
