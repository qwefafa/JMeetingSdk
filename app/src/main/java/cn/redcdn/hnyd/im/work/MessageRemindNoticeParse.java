...
import cn.redcdn.hnyd.im.meetingIm.ImConnectService;
import cn.redcdn.hnyd.im.util.IMCommonUtil;
import cn.redcdn.log.CustomLog;

/**
 * Desc
 * Created by wangkai on 2017/5/16.
 */

public class MessageRemindNoticeParse extends MessageBaseParse {
    private MessageReceiveAsyncTask.PrivateMessage msg = null;
    private int type = -1;
    private ExtInfo extInfo = null;

    public MessageRemindNoticeParse(MessageReceiveAsyncTask.PrivateMessage msg){
        this.msg = msg;
        this.type = FileTaskManager.NOTICE_TYPE_REMIND_SEND;
    }
    ...
    public boolean parseMessage(){
        ...
        switch(verInt){
            ...
            default:{
                //把多张图片拆解成多条记录插入到本地
                IMCommonUtil.setRemindKeyValue(txt, msg.gid);
                String body = noticesDao.createRecRemindMsgBody(msg.extendedInfo);
