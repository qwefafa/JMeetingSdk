...
import cn.redcdn.hnyd.im.adapter.MessageListCursorAdapter;
import cn.redcdn.hnyd.im.agent.AppP2PAgentManager;
import cn.redcdn.hnyd.im.asyncTask.QueryNoticeAsyncTask;
...
import cn.redcdn.hnyd.util.PermissionTool;
...
import static cn.redcdn.hnyd.im.activity.ChatActivity.KEY_SERVICE_NUBE_INFO;
...
public class MessageFragment extends BaseFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        selfNubeNumber = AccountManager.getInstance(getActivity()).getmAuthInfo().getNubeNumber();
        saveAdminNubeInfo();
    }
    ...
    private void showMoreTitle() {
        ...
        if (moreInfo == null) {
            ...
            moreInfo.add(
                    new PopDialogActivity.MenuInfo(R.drawable.temp_pop_dialog_startgroupchat, getString(R.string.Initiated_group_chat),
                            new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
            ...
            moreInfo.add(
                    new PopDialogActivity.MenuInfo(R.drawable.temp_pop_dialog_addfriend, getString(R.string.add_friend),
                            new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                    ...
                    new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (PermissionTool.isCameraPermission()) {
                                ...
                                CustomToast.show(getActivity(), getString(R.string.reopen_camera_authority), 1);
                            }
            ...
            public void onResult(String _interfaceName,
                ...
                if (_interfaceName.equals(
                    ...
                    if (successOrfaliure) {
                        ...
                        CustomToast.show(MedicalApplication.getContext(), getString(R.string.creat_group_fail_try_again), 1);
                    }
                    removeLoadingView();
                }
            }
