package cn.redcdn.hnyd.im.view;
...
import static cn.redcdn.hnyd.R.id.business_car_nube_id;
import static cn.redcdn.hnyd.util.CommonUtil.getColor;
...
public class CommonDialog {
    ...
    public void setTransmitMeetingInfo(int meetingMeetingType, String
        ...
        LinearLayout time_ll = (LinearLayout) contentView.findViewById(R.id.transmit_meeting_time_ll);
        ll.setVisibility(View.VISIBLE);
        ...
        if (FileTaskManager.NOTICE_TYPE_MEETING_BOOK == meetingMeetingType) {
            meetingDesTv.setText(creator + "context.getResources().getString(R.string.booked_a_video_consultation)" + meetingRoomId);
            meetingTypeTv.setText(context.getResources().getString(R.string.appointment_consultation));
            ...
            meetingTypeTv.setText(context.getResources().getString(R.string.appointment_consultation));
            meetingDesTv.setText(creator + "召开了视频会诊" + meetingRoomId);
        }
        contentView.findViewById(R.id.line_2).setVisibility(View.VISIBLE);
    }
    ...
    public void setTransmitItemByItem(String size) {
        if (TextUtils.isEmpty(size)) {
            ...
            cardName.setText(context.getResources().getString(R.string.altogether) + size + context.getResources().getString(R.string.the_message));
            contentView.findViewById(R.id.line_2).setVisibility(View.VISIBLE);
        }
    }
    ...
    public void setSingleMerge(String sender, String reciever) {
        ...
        if (TextUtils.isEmpty(sender)) {
            cardName.setText(reciever + context.getResources().getString(R.string.the_chat_history));
        }else{
            cardName.setText(sender + context.getResources().getString(R.string.with) + reciever + context.getResources().getString(R.string.the_chat_history));
        }
    ...
    public void setGroupChatMerge(String groupChatName) {
        if (TextUtils.isEmpty(groupChatName)) {
            ...
            TextView cardId = (TextView) contentView
                    .findViewById(R.id.business_car_name);
            cardId.setVisibility(View.GONE);
            cardName.setText(groupChatName + context.getResources().getString(R.string.the_chat_history));
            contentView.findViewById(R.id.line_2).setVisibility(View.VISIBLE);
        }
    }
