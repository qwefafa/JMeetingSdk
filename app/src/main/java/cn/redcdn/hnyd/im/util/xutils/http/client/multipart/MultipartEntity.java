...
package cn.redcdn.hnyd.im.util.xutils.http.client.multipart;

import cn.redcdn.hnyd.im.util.xutils.http.client.callback.RequestCallBackHandler;
import cn.redcdn.hnyd.im.util.xutils.http.client.callback.UploadEntity;
...
//            final Charset charset) {
//        StringBuilder buffer = new StringBuilder();
//        buffer.append("multipart/" + multipartSubtype );
//        if (charset != null) {
//            buffer.append("; charset=");
//            buffer.append(charset.name());
//        }
