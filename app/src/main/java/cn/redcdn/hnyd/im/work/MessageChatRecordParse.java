...
/**
 * Desc
 * Created by wangkai on 2017/5/10.
 */

public class MessageChatRecordParse extends MessageBaseParse {

    private MessageReceiveAsyncTask.PrivateMessage msg = null;
    private int type = -1;
    private ExtInfo extInfo = null;

    public MessageChatRecordParse(MessageReceiveAsyncTask.PrivateMessage msg){
        this.msg = msg;
        this.type = FileTaskManager.NOTICE_TYPE_CHATRECORD_SEND;
    }
    ...
    public boolean parseMessage(){
        ...
        switch(verInt){
            ...
            default:{
                ...
                String body = noticesDao.createRecChatRecordMsgBody(msg.extendedInfo);
