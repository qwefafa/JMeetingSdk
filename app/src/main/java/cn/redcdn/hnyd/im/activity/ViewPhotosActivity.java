...
import cn.redcdn.hnyd.im.activity.ViewImages.PhotoView;
import cn.redcdn.hnyd.im.activity.ViewImages.PhotoViewAttacher;
...
//                        alertMassage(getString(R.string.save_picture_tip, filePath));
                        // 发广播刷新系统媒体库
                        CustomToast.show(ViewPhotosActivity.this, getString(R.string.have_save_local_album), Toast.LENGTH_SHORT);
...
//        PhotoBean photo = mListPhoto.get(position);
    ...
    private void showDialog() {
        ...
        final MedicalAlertDialog dialog = new MedicalAlertDialog(ViewPhotosActivity.this);
        if (bean.getLocalPath().toLowerCase().endsWith(".wmv")
            ...
            final NoticesBean noticebean = new NoticesDao(ViewPhotosActivity.this)
    ...
    public void finish() {
        ...
        myHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                ViewPhotosActivity.super.finish();
