...
public class MediaFile {
    ...
    // 为 flv视频格式 增加一个自定义的MIME类型
    public static final int FILE_TYPE_FLV = 26;
    private static final int FIRST_VIDEO_FILE_TYPE = FILE_TYPE_MP4;
    private static final int LAST_VIDEO_FILE_TYPE = FILE_TYPE_FLV;
    ...
    static {
        ...
        addFileType("FLV", FILE_TYPE_FLV, "flv-application/octet-stream");
    ...
    public static boolean isWebpImageFileType(int fileType) {
        return fileType == FILE_TYPE_WEBP;
    }
    ...
    public static boolean isWebpImageFileType(String path) {
        MediaFileType type = getFileType(path);
        if (null != type) {
            return isWebpImageFileType(type.fileType);
        }
        return false;
    }
