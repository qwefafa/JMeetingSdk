...
/**
 * Desc
 * Created by wangkai on 2017/6/6.
 */

public class MessageRemindOneNoticeParse extends MessageBaseParse {

    private MessageReceiveAsyncTask.PrivateMessage msg = null;
    private int type = -1;
    private ExtInfo extInfo = null;

    public MessageRemindOneNoticeParse(MessageReceiveAsyncTask.PrivateMessage msg){
        this.msg = msg;
        this.type = FileTaskManager.NOTICE_TYPE_REMIND_ONE_SEND;
    }
