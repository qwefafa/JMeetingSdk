...
import cn.redcdn.hnyd.im.bean.MediaItem;
...
public class MultiBucketChooserActivity extends
    ...
    public static MultiBucketChooserActivity instance = null;
...
//        gridView.setColumnWidth(imgSize);
        ...
        LogUtil.end("");
        Intent i = new Intent(this, MultiChoosePicActivity.class);
...
//        }
    ...
    protected void clickPosition(int position) {
        ...
        if (isPicEmpty && position == 0) {
            CustomToast.show(MultiBucketChooserActivity.this,getString(R.string.no_content),CustomToast.LENGTH_LONG);
          return;
        }
            ...
            if (!list.get(pos).getNum().equals("0")) {
                ...
                if (pos == 0) {
                    ...
                    if ( cursor.getCount() > 0||cursor1.getCount()>0) {
                        ...
                        viewHolder.bucketCount.setText("(" + (cursor.getCount() + cursor1.getCount()) + ")");
                        isPicEmpty = false;
                    }else {
                        viewHolder.bucketName
                                .setText(R.string.photo_album_film);
