...
/**
 * Desc
 * Created by wangkai on 2017/8/27.
 */
...
public class MyCacheStuffer extends SpannedCacheStuffer {
    ...
    public MyCacheStuffer(Context context) {
        ...
        AVATAR_DIAMETER = dp2px(context, 33);
        AVATAR_PADDING = dp2px(context, 1);
        TEXT_LEFT_PADDING = dp2px(context, 2);
        TEXT_RIGHT_PADDING = dp2px(context, 8);
        TEXT_SIZE = dp2px(context, 13);
        TEXT_BG_RADIUS = dp2px(context, 8);
    }
