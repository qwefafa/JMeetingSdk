...
public class MeizuUtils {
     ...
     * 去魅族权限申请页面
     */
    public static void gotoMeizuApplyPermissionActivity(Context context) {
        CustomLog.i(TAG, "gotoMeizuApplyPermissionActivity()");
        ...
        try {
            ...
            CustomLog.e(TAG, "gotoMeizuApplyPermissionActivity() failed" + e.toString());
